...
public class HdfsOperateStudy {
    ...
    public void getHdfsFile() throws Exception {
        ...
        //使用输出流，将文件写到哪里去
        //通过new url的方式打开一个文件流
        InputStream inputStream = new URL("hdfs://node01:8020/wordcount/input/wordcount.txt").openStream();
    ...
    public void copyHdfsToLocal() throws Exception {
        ...
        //给定hdfs文件的路径
        Path path = new Path("/install.log");
        //使用一个输入流去读取hdfs的文件
    ...
    public void createHdfsDir() throws Exception {
        ...
        fileSystem.mkdirs(new Path("/wordcount/input"));
        fileSystem.close();
    }
    ...
    public void uploadFileToHdfs() throws Exception {
        ...
        fileSystem.copyFromLocalFile(false, new Path("file:///d:\\wordcount\\input\\wordcount.txt"), new Path("/wordcount/input"));
       /*
        第二种文件上传方式，通过流的方式来做
